...
print(Fore.RESET + 'For this to work I need some sort of input from you! \nI will need a Artist, a Track,'
                   ' Energy, Mood.')
print()
...
# Indexes
''' energy = ('Dull', 'Detached', 'Calm', 'Emphatic', 'Excited')

mood = ('Melancholic', 'Sad', 'Optimistic', 'Happy', 'Ecstatic')

streams = ['Low', 'Good', 'High'] '''
